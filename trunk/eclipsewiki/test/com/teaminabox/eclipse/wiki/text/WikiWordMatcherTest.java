...
public final class WikiWordMatcherTest extends AbstractTextRegionMatcherTest {
	...
	private static final TextRegionTestBean[]	ACCEPTABLE_CASES	= new TextRegionTestBean[] { 
		new TextRegionTestBean("WikiWord", new WikiWordTextRegion("WikiWord")), 
		new TextRegionTestBean("WikiWord etc.", new WikiWordTextRegion("WikiWord")), 
		new TextRegionTestBean("WikiWord.", new WikiWordTextRegion("WikiWord")), 
		new TextRegionTestBean("WikiWord123", new WikiWordTextRegion("WikiWord123")), 
		new TextRegionTestBean("WikiWord AnotherWikiWord", new WikiWordTextRegion("WikiWord")) };
