...
public class FolderUtils {
     ...
     * @param prefix Name for the folder to create (will be suffixed with a random number)
     * @param baseFolder Where to create the new folder
     * @return A File representation of the newly created folder
     * @throws IOException
     */    
    public static File createTempFolder(String prefix, File baseFolder)
    throws IOException
    {
	 ...
	 * 
	 * @param fileOrFolder the location of the old file or directory
	...
	/**
	 * For stubborn Windows files, attempts to delete the specified file or folder structure.  
	 * Will keep trying up to maxTries times, pausing longer with each attempt.
	 * @param name
	 * @param fileOrFolder
	 * @param maxTries
	 * @return The number of tries required: -1 = could not delete (gave up), 0 = already deleted, 1 = deleted on first try, 2 = deleted on second try, etc.  
	 * @throws Exception
	 * @usage 
	 * <code>
	 * try { 
